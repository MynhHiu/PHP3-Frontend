  ...
  <div class="admin-shell">
    ...
    <aside :class="['admin-sidebar', !open && 'collapsed']">
      ...
      <nav class="sidebar-nav">
        ...
        <template v-if="open">
          <p class="nav-section" style="margin-top:8px">Quản lý</p>
        </template>
        ...
        <router-link to="/admin/brands" custom v-slot="{ isActive, navigate }">
          <div @click="navigate" :class="['nav-link', isActive && 'active', !open && 'center']"
            :title="!open ? 'Thương hiệu' : ''">
            <IconList class="nav-icon" />
            <span v-if="open">Thương hiệu</span>
          </div>
        </router-link>

        <router-link to="/admin/banners" custom v-slot="{ isActive, navigate }">
          <div @click="navigate" :class="['nav-link', isActive && 'active', !open && 'center']"
            :title="!open ? 'Banner' : ''">
            <IconBanner class="nav-icon" />
            <span v-if="open">Banner</span>
          </div>
        </router-link>
