    ...
    <section class="hero-wrap">
      <div class="u-container hero-inner">
        ...
        <div class="main-banner">
              ...
              <div class="b-img-wrap">
                ...
                <div class="b-img-inner">
                  <svg viewBox="0 0 120 120" fill="none" class="b-icon">
                    <rect x="20" y="30" width="80" height="55" rx="6" stroke="rgba(255,255,255,0.8)" stroke-width="2.5" fill="rgba(255,255,255,0.07)"/>
                    <rect x="30" y="40" width="60" height="35" rx="3" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.5)" stroke-width="1.5"/>
                    <path d="M40 50h40M40 58h28" stroke="rgba(255,255,255,0.7)" stroke-width="2" stroke-linecap="round"/>
                    <path d="M35 85v8h50v-8" stroke="rgba(255,255,255,0.6)" stroke-width="2"/>
                    <circle cx="90" cy="35" r="10" fill="rgba(255,255,255,0.1)" stroke="rgba(255,255,255,0.6)" stroke-width="1.5"/>
                    <path d="M86 35h8M90 31v8" stroke="rgba(255,255,255,0.7)" stroke-width="1.5" stroke-linecap="round"/>
                  </svg>
                </div>
              </div>
            </div>
          ...
          <div class="b-dots">
            <button
              ...
              :class="['b-dot', { active: i === currentBanner }]"
        ...
        <div class="side-banners">
          <div class="side-b side-b-1" @click="$router.push('/products?category=dieu-hoa')">
            <div class="side-b-inner">
              <span class="side-b-tag">HOT DEAL</span>
              <div class="side-b-title">Điều hòa Inverter</div>
              <div class="side-b-disc">Tiết kiệm điện đến 60%</div>
              <span class="side-b-cta">Xem ngay →</span>
            </div>
          </div>
          <div class="side-b side-b-2" @click="$router.push('/products?category=nha-bep')">
            <div class="side-b-inner">
              <span class="side-b-tag">MỚI VỀ</span>
              <div class="side-b-title">Đồ dùng nhà bếp</div>
              <div class="side-b-disc">Thương hiệu châu Âu</div>
              <span class="side-b-cta">Xem ngay →</span>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div class="pg-img-wrap">
              ...
              <div class="pg-overlay">
                <button
                  class="pg-cart-btn"
                  @click.stop="$router.push(`/products/${p.id}`)"
                  title="Thêm vào giỏ"
                >
...
const banners = [
  { label: 'Ưu đãi đặc biệt', title: 'Máy lạnh Inverter tiết kiệm điện', sub: 'Bảo hành 2 năm chính hãng toàn quốc', price: '8.990.000đ', bg: 'linear-gradient(135deg,#0d4f2d 0%,#1e8a52 60%,#0d7a42 100%)' },
  { label: 'Hàng mới về', title: 'Thiết bị điện thông minh 2025', sub: 'Nhà thông minh — Giá cực ưu đãi hôm nay', price: '1.290.000đ', bg: 'linear-gradient(135deg,#0a2d5c 0%,#1255a8 60%,#0e4d96 100%)' },
  { label: 'Flash Sale', title: 'Quạt điện, quạt trần giảm sốc', sub: 'Hàng trăm sản phẩm giảm đến 50% mỗi ngày', price: '390.000đ', bg: 'linear-gradient(135deg,#5c1d0a 0%,#b53a1a 60%,#9e2d0d 100%)' },
]
...
.b-shape-1 { width: 340px; height: 340px; background: rgba(255,255,255,.06); top: -120px; right: -80px; }
.b-shape-2 { width: 200px; height: 200px; background: rgba(255,255,255,.07); bottom: -80px; right: 140px; }
.b-shape-3 { width: 110px; height: 110px; background: rgba(255,255,255,.08); top: 50px; right: 220px; }

.b-content { position: relative; z-index: 2; max-width: 350px; }
.b-label {
...
.b-sub { font-size: 13.5px; color: rgba(255,255,255,.85); margin-bottom: 18px; line-height: 1.6; }
.b-price-row {
  display: flex;
...
.b-price-from { font-size: 13px; color: rgba(255,255,255,.75); }
.b-price-val  { font-size: 28px; font-weight: 900; color: #fff; text-shadow: 0 2px 8px rgba(0,0,0,.15); }
.b-cta {
  background: #fff;
  color: #1a5c2e;
  border: none;
...
.b-cta:hover { transform: translateY(-2px); box-shadow: 0 8px 28px rgba(0,0,0,.2); }

.b-img-wrap { position: relative; z-index: 2; flex-shrink: 0; }
.b-img-circle {
...
.b-arrow:hover { background: rgba(255,255,255,.35); }
.b-prev { left: 14px; } .b-next { right: 14px; }
.b-dots { position: absolute; bottom: 14px; left: 50%; transform: translateX(-50%); display: flex; gap: 7px; z-index: 5; }
.b-dot {
  width: 8px; height: 8px; border-radius: 50%;
  background: rgba(255,255,255,.4); border: none; cursor: pointer;
  transition: all .25s;
}
.b-dot.active { background: #fff; width: 26px; border-radius: 4px; }

/* Side banners */
.side-banners { display: flex; flex-direction: column; gap: 14px; height: 360px; }
.side-b {
  flex: 1; border-radius: 14px; cursor: pointer; overflow: hidden;
  position: relative; transition: transform .2s;
  box-shadow: 0 4px 16px rgba(0,0,0,.1);
}
.side-b:hover { transform: translateY(-3px); }
.side-b-1 { background: linear-gradient(135deg, #c45c00, #f09030); }
.side-b-2 { background: linear-gradient(135deg, #004fa8, #0090d4); }
.side-b::before {
  content: '';
  position: absolute;
...
.side-b-inner { padding: 22px 20px; position: relative; z-index: 1; }
.side-b-tag {
...
.side-b-title { font-size: 16px; font-weight: 800; color: #fff; margin-bottom: 5px; }
.side-b-disc  { font-size: 12px; color: rgba(255,255,255,.82); margin-bottom: 14px; }
.side-b-cta {
...
.side-b:hover .side-b-cta { background: rgba(255,255,255,.36); }
...
.trust-cell { display: flex; align-items: center; gap: 10px; }
.trust-ico  { font-size: 22px; flex-shrink: 0; }
.trust-text { display: flex; flex-direction: column; }
.trust-text strong { font-size: 13px; font-weight: 700; color: #1a1a1a; line-height: 1.3; }
.trust-text span   { font-size: 11.5px; color: #888; }
...
/* ─── LEFT SIDEBAR ─── */
.left-sidebar { display: flex; flex-direction: column; gap: 14px; }
...
.ls-title svg { width: 15px; height: 15px; flex-shrink: 0; }

.ls-cat-list { padding: 6px 0; }
.ls-cat-link {
  display: flex;
  align-items: center;
  gap: 9px;
...
.ls-cat-link:hover, .ls-cat-link.active {
  background: #f0faf4;
  color: #1a6e35;
}
.ls-cat-ico  { font-size: 14px; width: 20px; text-align: center; }
.ls-cat-name { flex: 1; }
...
.pf-btn:hover { border-color: #2d8c4e; color: #1a6e35; background: #ecf7ef; }
.pf-btn.active { background: #2d8c4e; color: #fff; border-color: #2d8c4e; }
...
.breadcrumb a { color: #2d8c4e; text-decoration: none; }
...
.sort-label { font-size: 13px; color: #666; font-weight: 600; flex-shrink: 0; }
...
.sort-tab:hover  { border-color: #2d8c4e; color: #2d8c4e; }
.sort-tab.active { background: #2d8c4e; color: #fff; border-color: #2d8c4e; }
.sort-count { margin-left: auto; font-size: 12.5px; color: #999; flex-shrink: 0; }
...
.pg-badge-sale { background: #e53e3e; color: #fff; font-size: 10px; font-weight: 800; padding: 3px 8px; border-radius: 20px; letter-spacing: .3px; }
.pg-badge-new  { background: #2d8c4e; color: #fff; font-size: 10px; font-weight: 800; padding: 3px 8px; border-radius: 20px; }
.pg-badge-hot  { background: #e67e22; color: #fff; font-size: 10px; font-weight: 800; padding: 3px 8px; border-radius: 20px; }
...
.pg-cart-btn svg { width: 15px; height: 15px; flex-shrink: 0; }
.pg-cart-btn:hover { background: #1a5c2e; }
...
.pg-quick-view svg { width: 16px; height: 16px; }
.pg-quick-view:hover { background: rgba(255,255,255,.25); }

/* Card info */
.pg-info { padding: 12px 12px 14px; flex: 1; display: flex; flex-direction: column; gap: 5px; }
.pg-brand { font-size: 11px; color: #2d8c4e; font-weight: 700; text-transform: uppercase; letter-spacing: .5px; }
.pg-name {
  font-size: 13px;
  color: #222;
  font-weight: 500;
...
.pg-stars { display: flex; align-items: center; gap: 1px; }
.star { font-size: 12px; color: #ddd; transition: color .1s; }
.star.filled { color: #f5a623; }
.pg-review-count { font-size: 11px; color: #aaa; margin-left: 4px; }
.pg-price-row { display: flex; align-items: baseline; gap: 8px; margin-top: 2px; }
.pg-price-new { color: #e03131; font-weight: 800; font-size: 15px; }
.pg-price-old { color: #bbb; font-size: 12px; text-decoration: line-through; }
...
.page-btn:hover:not(:disabled) { border-color: #2d8c4e; color: #2d8c4e; background: #f0faf4; }
.page-btn.active { background: #2d8c4e; color: #fff; border-color: #2d8c4e; }
...
.home-toast.success { background: #1a6e35; color: #fff; }
.home-toast.error   { background: #c62828; color: #fff; }
.home-toast.warning { background: #d46b08; color: #fff; }
...
@media (max-width: 1024px) {
  ...
  .side-banners { flex-direction: row; height: auto; }
  .side-b { min-height: 130px; }
...
@media (max-width: 768px) {
  ...
  .trust-strip-inner { justify-content: flex-start; gap: 16px; }
  .sort-bar { gap: 8px; }
