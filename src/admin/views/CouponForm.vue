        ...
        <div class="form-col">
            ...
            <div class="form-inner">
              ...
              <div class="field">
                ...
                <input
                  ...
                  @input="form.coupon_code = (form.coupon_code as string).toUpperCase()"
                  :disabled="isEdit"
                />
              ...
              <div class="form-row-2">
                ...
                <div class="field">
                  <label class="label">
                    ...
                    <span style="font-weight:400;color:var(--gray-400)">{{ discountType === 'percent' ? '(%)' : '(₫)' }}</span>
                  </label>
                  <input
              ...
              <div class="field">
                ...
                <textarea
                  ...
                  class="input"
                  rows="3"
                  placeholder="VD: Giảm 20% cho đơn từ 200k - áp dụng tháng 6/2026"
                ></textarea>
              </div>
          ...
          <div v-if="discountValue > 0" class="section-card" style="background:var(--gray-50)">
            ...
            <p style="font-size:12px;color:var(--gray-400);margin-top:4px">
              Lưu DB: <code style="background:var(--gray-100);padding:2px 6px;border-radius:4px">{{ computedDiscount }}</code>
            </p>
          </div>
